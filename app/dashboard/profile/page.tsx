        ...
        <form className="space-y-6">
          ...
          <div className="mt-6">
            ...
            <div>
              <button
                type="button"
                className="mt-4 flex w-full justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-green-700"
              >
                Add New User
              </button>
            </div>
